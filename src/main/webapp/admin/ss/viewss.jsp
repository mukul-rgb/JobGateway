...
<body>
    ...
    <div class="container">
                ...
                <div class="col-md-4">
                    <div class="card card-wrapper">
                        ...
                        <div class="card-body">
							...
							onclick="window.location.href='deleteStory.jsp?ssid=<%= ssid %>';">Delete</button>
        ...
        <div class="text-center mt-4">
            <button class="btn btn-success" onclick="window.location.href = 'addStudent.jsp';">Add Student</button>
        </div>
    </div>
